...
#Adjust width between LE
adjust_width = True

#Load random existing snle image
snle_filename = 'dlw1_20221114_20181004_r_diff.fits'
snle = fits.open(snle_filename)[0]
snle_data = snle.data

#Load corresponding snle mask
mask = "mask_dlw1_20221114_20181004_detailed.png"
mask_raw = imread(mask)
mask_image = np.dot(mask_raw[...,:4], [1, 1, 1, 1])
snle_name = mask.split('mask_')[1].split('.png')[0]
...
#Adjust width
if adjust_width==True:
    angle_upward = -20
    array = rotate(array, angle_upward, reshape=False)
    gap_width = random.randint(90, 500)
    array[1220:1430, 1030-gap_width:1120-gap_width] = array[1220:1430, 1030:1120]
    array[1220:1430, 1030:1120] = 0
